...
// Query to fetch all family members
$query = "SELECT * FROM Familymembers";
$result = $conn->query($query);

if (!$result) {
    $error_message = "Error fetching family members: " . $conn->error;
}
?>
...
<section class="display-section">
    ...
    <h2>Volleyball Club Family Members</h2>
    ...
    <?php if ($result && $result->num_rows > 0): ?>
        ...
        <table>
            <tr>
                ...
                <th>Email</th>
                <th>Medicare</th>
                <th>Related Family Member ID</th>
            </tr>
        </div>
            <?php while ($row = $result->fetch_assoc()): ?>
                <tr>
                    <td><?php echo htmlspecialchars($row['familymember_id']); ?></td>
                    ...
                    <td><?php echo htmlspecialchars($row['familymember2_id']); ?></td>
                </tr>
            <?php endwhile; ?>
        </table>
    <?php else: ?>
    ...
    <a href="create_familymembers.php" class="btn">Add New Family Member</a>
